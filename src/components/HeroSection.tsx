  ...
  return <section className="py-12 bg-background">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-semibold text-foreground mb-3">Directorio Profesional de Ingredientes Culinarios</h2>
          ...
          <div className="max-w-md mx-auto mb-6">
            <div className="relative">
              ...
              <Input type="text" placeholder="Buscar ingredientes..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} onKeyPress={handleKeyPress} className="pl-10 h-10" />
            </div>

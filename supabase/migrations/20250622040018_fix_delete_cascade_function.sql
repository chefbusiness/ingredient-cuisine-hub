...
-- Corregir la función para eliminar ingrediente - fix de referencias de columnas
...
BEGIN
    ...
    -- Eliminar precios (corregir referencia)
    ...
    -- Eliminar usos (corregir referencia)
    ...
    -- Eliminar recetas (corregir referencia)
    ...
    -- Eliminar variedades (corregir referencia)
    ...
    -- Eliminar información nutricional (corregir referencia)
    ...
    -- Eliminar imágenes reales (corregir referencia)
